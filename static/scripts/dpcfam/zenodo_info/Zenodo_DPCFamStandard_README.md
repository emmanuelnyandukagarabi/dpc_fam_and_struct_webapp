...
For each MetaCluster, a representative AlphaFoldDB structure is reported, along with the following:
- E-value
- Sequence range
- hmm range
- hmm coverage
...
* **pfam_comparison.txt** lists for each MC the comparison with Pfam *ground truth*:
	...
	- column 3: DAC
	- column 4: percent of sequences in the MC matching the DA
	- column 5: %DAC
	- column 6: %DACF
	- column 7: %DACFA
	- column 8: average overlap of the former sequences with the DA
	- column 9: fred
	- column 10: fext
	- column 11: label describing qualitatively the overlap of the MC with its DA, which can be: equivalent, reduced, extended or shifted
	- column 12: pfam seqs
...
* **alphafoldDB.txt**  lists AlphaFoldDB representative structures for each metacluster. 
	- column 1: protein ID
	- column 2: MC index
	- column 3: MC hmm length
	- column 4: e-value
	- column 5: sequence start
	- column 6: sequence stop
	- column 7: hmm range start
	- column 8: hmm range stop
	- column 9: MC hmm coverage
	- column 10: average plddt



* **plddt_values.txt**  lists AlphaFold plddt values averaged over amino-acids covered by the metacluster. 
	- column 1: MC index
	- column 2: average plddt
